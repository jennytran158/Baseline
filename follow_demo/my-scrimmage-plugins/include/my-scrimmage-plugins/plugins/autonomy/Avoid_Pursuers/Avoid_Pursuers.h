...
#ifndef INCLUDE_MY_SCRIMMAGE_PLUGINS_PLUGINS_AUTONOMY_AVOID_PURSUERS_AVOID_PURSUERS_H_
#define INCLUDE_MY_SCRIMMAGE_PLUGINS_PLUGINS_AUTONOMY_AVOID_PURSUERS_AVOID_PURSUERS_H_
...
namespace scrimmage {
namespace autonomy {
class Avoid_Pursuers : public scrimmage::Autonomy {
 public:
...
#endif // INCLUDE_MY_SCRIMMAGE_PLUGINS_PLUGINS_AUTONOMY_AVOID_PURSUERS_AVOID_PURSUERS_H_
