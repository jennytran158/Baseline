...
#include <my-scrimmage-plugins/plugins/autonomy/Avoid_Pursuers/Avoid_Pursuers.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::Avoid_Pursuers,
                Avoid_Pursuers_plugin)

namespace scrimmage {
namespace autonomy {

void Avoid_Pursuers::init(std::map<std::string, std::string> &params) {
...
bool Avoid_Pursuers::step_autonomy(double t, double dt) {
...
void Avoid_Pursuers::velocity_controller(Eigen::Vector3d &v) {
