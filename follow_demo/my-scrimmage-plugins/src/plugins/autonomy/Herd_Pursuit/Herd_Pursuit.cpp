...
#include <my-scrimmage-plugins/plugins/autonomy/Herd_Pursuit/Herd_Pursuit.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::Herd_Pursuit,
                Herd_Pursuit_plugin)

namespace scrimmage {
namespace autonomy {

void Herd_Pursuit::init(std::map<std::string, std::string> &params) {
...
bool Herd_Pursuit::step_autonomy(double t, double dt) {
