...
#include <my-scrimmage-plugins/plugins/autonomy/Random_Turn/Random_Turn.h>
...
REGISTER_PLUGIN(scrimmage::Autonomy,
                scrimmage::autonomy::Random_Turn,
                Random_Turn_plugin)

namespace scrimmage {
namespace autonomy {

void Random_Turn::init(std::map<std::string, std::string> &params) {
...
bool Random_Turn::step_autonomy(double t, double dt) {
